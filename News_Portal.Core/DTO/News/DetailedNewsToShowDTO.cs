...
{
    public class DetailedNewsToShowDTO
    {
...
public static class DetailedNewsToShowDTOExtensions
{
    public static DetailedNewsToShowDTO ToDetailedNewsToShowDTO(this News news)
    {
        return new DetailedNewsToShowDTO
        {
            NewsId = news.NewsId,
