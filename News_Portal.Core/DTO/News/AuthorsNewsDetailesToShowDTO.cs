...
{
    public class AuthorsNewsDetailesToShowDTO
    {
...
public static class AuthorsNewsDetailesToShowDTOExtensions
{
    public static AuthorsNewsDetailesToShowDTO ToAuthorsNewsDetailesToShowDTO(this News news)
    {
        return new AuthorsNewsDetailesToShowDTO
        {
            NewsId = news.NewsId,
